...
namespace DATINGAPP.API.Data
{
    public class DatingRepository : IDatingREpository
    {
        ...
        {
            return await context.Likes.FirstOrDefaultAsync(u => u.LikerId == userId && u.LikeeId == recepientId);
        }
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            if(userParams.MinAge != 18 || userParams.MaxAge != 99)
            {
                ...
                users = users.Where(u => u.DateOfBirth >= minDob && u.DateOfBirth <= minDob);
            }
        ...
        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            switch (messageParams.MessageContainer)
            {
                ...
                case "OutBox": messages = messages.Where(u => u.SenderId == messageParams.UserId);
                    break;
                default: messages = messages.Where(u => u.RecipientId == messageParams.UserId && u.IsRead == false);
                    break;
            }
